...
public class ButtonClickedEvent extends Event {
	...
	ButtonInteractionEvent e;
			public ButtonClickedEvent(DiscordLink plugin, ButtonLink buttonLink, ChannelLink channelLink, UserLink userLink, Message message, boolean fromPrivateChannel, ButtonInteractionEvent e) {
		this.plugin = plugin;
